...
*/
/*
기존 Object 기반의 FruitBox 를 아래와 같이 제네릭 클래스로 변경한다. 자료형에 해당하는 부분을 타입매개변수 T(Type) 로 교체하고 
...
public class Ex02GenericClass {
	...
	public static void main (String[] args) {
		...
		각각 apple , banana 객체 저장할 수 있는 인스턴스가 생성되었다.
		*/
		...
		/*
		OrangeBox 는 인스턴스 생성시 Orange 를 저장 할 수 있는 용도로 생성되었기 때문에 
		다른 객체는 저장 할 수 없다.
