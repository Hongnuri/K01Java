...
class FruitBuyer2{
	...
	public FruitBuyer2(int _myMoney, int _numOfApple) {
		myMoney = _myMoney;
...
public class E03InformationHiding2 {
	...
	public static void main(String[] args) {
		...
		FruitSeller2 seller1 = new FruitSeller2(0, 100, 1000);

		//판매자2 : 보유갯수 80개, 단가 500원
		FruitSeller2 seller2 = new FruitSeller2(0, 80, 500);

		FruitBuyer2 buyer = new FruitBuyer2(10000, 0);
