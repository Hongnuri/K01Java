...
/*
추상 클래스1 : 추상메소드를 포함하지 않는 클래스
 */
abstract class AbsClass1 {
	
	// int형으로 표현 할 수 있는 최대값을 반환하는 Wrapper 클래스의 상수
...
class AbsClassChild1 extends AbsClass1 {
	...
	*/
	...
	/*
	추상클래스2 : 
	추상메소드를 포함한 클래스. 추상메소드를 멤버로 포함한 클래스는 
	반드시 abstract로 선언해야한다. 그렇지 않으면 에러가 발생된다.
	*/
	...
	/*
	부모가 가진 추상메소드를 그대로 상속 받게 되므로 해당클래스도 반드시 abstract 로 선언해야한다.
	...
	public class E01AbstractBasic {
		...
		public static void main(String[] args) {
			...
			*/
			...
			/*
			추상클래스 내에 선언 된 정적멤버는 오버라이딩의 대상이 아니므로
			static 이 가진 기본규칙을 따른다.
			즉 , 클래스명으로 접근하면 된다.
			*/
