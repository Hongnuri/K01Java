...
public class E05LocalDateTimeO {
	...
	public static void main(String[] args) {
		...
		// 가장 가까운 요일 , n 번 째 요일 등을 간단한 코드로 가져올 수 있다.
		...
		System.out.println("X-mas 까지 앞으로 " + left.getMonths() + "개월" + left.getDays() + "일");
		...
		System.out.println("현재 월을 영문으로 표기: " + nowDate.getMonth());
