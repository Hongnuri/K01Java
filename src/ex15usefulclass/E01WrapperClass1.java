...
- 오토박싱 : 기본자료형이 참조형으로 자동변환 하는 것
- 오토언박싱 : 참조형이 기본자료형으로 자동 변환 되는 것
JDK1.5 이상에서 적용된다.
*/
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		toString() : 인스턴스 변수를 출력시 참조 값이 아니라 실제 저장 된 값을 문자열 형태로 반환해준다.
		hashCode() : 객체를 구별하기 위해 참조 값을 고유한 정수 값으로 반환해준다.
		*/
