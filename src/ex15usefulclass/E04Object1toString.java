...
Object 클래스
- 자바에서 최상의 클래스
- 별도의 선언 없이 Object 에 정의 된 모든 메소드를 사용할 수 있다.
- 개발자가 정의한 모든 클래스를 Object 의 인스턴스로 정의 할 수 있다.
...
/*
toString() 메소드
- Object 클래스에 정의 된 메소드로 println() 이 문자열을 출력하기 전에 자동으로 호출하는 메소드이다
- 인스턴스 변수를 문자열 형태로 변환하여 반환한다.
- 필요한 경우 클래스 정의시 오버라이딩하여 재정의하는 것이 좋다. 단 , 필수사항이 아니다.
*/
